...
public final class Equipment {
     ...
     */
    public enum Slot {
        HEAD(0, 24431), CAPE(1, 24432), NECK(2, 24433), WEAPON(3, 24434), BODY(4, 24436), SHIELD(5, 24437), LEGS(7,
                                                                                                                 24438), HANDS(
                9, 24439), FEET(10, 24440), RING(12, 24435), AMMUNITION(13, 24441), AURA(14, 24442), POCKET(17, 24443);
