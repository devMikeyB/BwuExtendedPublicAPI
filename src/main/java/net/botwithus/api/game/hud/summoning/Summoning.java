...
public class Summoning {
    private static final int MINUTES_REMAINING_VARBIT_ID = 6055,
            CURRENT_HEALTH_VARBIT_ID = 19034,
            TOTAL_HEALTH_VARBIT_ID = 27403,
            VARBIT_CURRENT_SUMMONING_POINTS = 41524;

    private static final int MINUTE_REMAINING_VARP_ID = 1786,
            HEALTH_VARP_ID = 5194,
            VARP_CURRENT_LEFT_CLICK_OPTION = 1789,
            VARP_SPECIAL_MOVE_POINTS = 1787;
